...
type MotionProps = HTMLAttributes<HTMLDivElement> & { initial?: object; animate?: object; transition?: object };
let Motion: React.FC<MotionProps> = (p) => <div {...p} />; // local minimal fallback
if (typeof window !== 'undefined') {
  import('framer-motion')
    .then(m => { if (m.motion?.div) Motion = m.motion.div; })
    .catch(() => {});
}
